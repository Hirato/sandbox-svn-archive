...
namespace game
{
     ...
     static const playermodelinfo playermodels[] =
    {
        ...
        { "captaincannon/blue", "captaincannon/blue", "captaincannon/red", "captaincannon/hudguns", NULL, NULL, { NULL, NULL, NULL }, "captaincannon_blue", "captaincannon_blue",
"captaincannon_red", true },
        { "captaincannon/red", "captaincannon/blue", "captaincannon/red", "captaincannon/hudguns", NULL, NULL, { NULL, NULL, NULL }, "captaincannon_red", "captaincannon_blue",
"captaincannon_red", true },
    ...
    void drawhudmodel(fpsent *d, int anim, float speed = 0, int base = 0)
    {
        ...
        rendermodel(gunname, anim, sway, testhudgun ? 0 : d->yaw, testhudgun ? 0 : d->pitch, d->roll, MDL_NOBATCH, interp, a, base, (int)ceil(speed));
    }
