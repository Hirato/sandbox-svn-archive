...
static const struct guninfo { int sound, attackdelay, damage, spread, projspeed, kickamount, range, rays, hitpush, exprad, ttl; const char *name, *file; short part; } guns[NUMGUNS] =
{
    ...
    { S_SG,       1400,  15, 400,   0, 20, 1024, 20,  80,  0,    0, "shotgun",         "shotg",  0 },
    { S_CG,        100,  20, 100,   0,  7, 1024,  1,  80,  0,    0, "chaingun",        "chaing", 0 },
    { S_RLFIRE,   1800, 120,   0, 180, 10, 1024,  1, 160, 40,    0, "rocketlauncher",  "rocket", 0 },
    { S_RIFLE,    1500,  75,   0,   0, 30, 2048,  1,  80,  0,    0, "rifle",           "rifle",  0 },
    { S_FLAUNCH,  2000, 175,   0, 300, 10, 1024,  1, 250, 45, 1500, "grenadelauncher", "gl",     0 },
    { S_PISTOL,    500,  20,  50,   0,  7, 1024,  1,  80,  0,    0, "pistol",          "pistol", 0 },
    { S_FLAUNCH,   200,  20,   0,  50,  1, 1024,  1,  80, 40,    0, "fireball",        NULL,     PART_FIREBALL1 },
    { S_ICEBALL,   200,  40,   0,  30,  1, 1024,  1,  80, 40,    0, "iceball",         NULL,     PART_FIREBALL2 },
    { S_SLIMEBALL, 200,  30,   0, 160,  1, 1024,  1,  80, 40,    0, "slimeball",       NULL,     PART_FIREBALL3 },
